...
int main() 
{
    ...
    for (int jugador = 1; jugador < 3; jugador++) 
    {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // Espera por la tecla Enter (sin necesidad de leer una respuesta de tipo char)
            getchar();  // Esto hace que el jugador presione Enter para sacar la carta

            // El jugador elige la carta
            jugada[i] = mazo[0];  
